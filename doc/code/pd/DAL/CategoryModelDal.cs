...
namespace NoName.NetShop.DAL
{
	...
	public class CategoryModelDal
	{
		...
		public NoName.NetShop.Model.CategoryModel GetModel(int CateId)
		{
			...
			NoName.NetShop.Model.CategoryModel model=null;
		...
		/// </summary>
		public List<NoName.NetShop.Model.CategoryModel> GetListArray(string strWhere)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select CateId,CateName,CatePath,Status,PriceRange,IsHide,CateLevel ");
			strSql.Append(" FROM pdCategory ");
			...
			List<NoName.NetShop.Model.CategoryModel> list = new List<NoName.NetShop.Model.CategoryModel>();
			Database db = DatabaseFactory.CreateDatabase();
		...
		/// 对象实体绑定数据
		/// </summary>
		public NoName.NetShop.Model.CategoryModel ReaderBind(IDataReader dataReader)
		{
