...
{
    public class SuitOrderProduct: OrderProduct
    {
        ...
        {
            SuitOrderProduct op = null;
            string sql = "Product_GetOrderProduct_Suit";
        ...
        {
            string sql = "orderItem_save_Suit";
        ...
        private SuitOrderProduct BuildModel(IDataReader reader)
        {
            SuitOrderProduct op = new SuitOrderProduct();
