<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" MasterPageFile="~/Site.master" ValidateRequest="false" Inherits="NoName.NetShop.ForeFlat.member.PawnShop.Edit" %>
...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="cpMain">
    ...
    <div class="currentPosition">
    	您现在的位置: <a href="/">首页</a> &gt;&gt; <a href="/member/myorders.aspx">我的鼎鼎</a> &gt;&gt; <a href="/member/PawnShop/List.aspx">我的典藏</a> &gt;&gt; <a href="#">修改当品</a>
    </div>
    <!--Position End-->
                    ...
                    <div class="sheet1">
                        ...
                        <ul class="form">
                            <li>
                                ...
                                <span class="tip"><a href="../CateSelect.aspx?app=PawnShop&pid=<%= PawnProductID %>">重新选择</a></span>
                            </li>
                            <li>
