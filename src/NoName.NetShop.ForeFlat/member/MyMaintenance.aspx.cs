...
{
    public partial class MyMaintenance : AuthBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                SearPageInfo.StrWhere = "contentType=4 and userid='" + CurrentUser.UserId + "'";
                ShowQuestionInfo();
            }
        }
        ...
        protected void lbtnDoQuestion_Click(object sender, EventArgs e)
        {
            ...
            qmodel.ContentType = NetShop.Common.ContentType.Maintenance;
            qmodel.ContentId = 0;
            qbll.Add(qmodel);
            ShowQuestionInfo();
        }
