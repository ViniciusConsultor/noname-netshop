<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Comments.aspx.cs" Inherits="NoName.NetShop.BackFlat.MagicWorld.PawnShop.Comments" %>
    ...
    <div>
        <asp:GridView runat="server" ID="GridView1" OnRowDataBound="GridView1_RowDataBound" AutoGenerateColumns="false" OnRowCommand="GridView1_RowCommand">
            <Columns>
                ...
                <asp:BoundField HeaderText="被评论产品" DataField="pawnproductname" />
