...
namespace NoName.NetShop.BackFlat.MagicWorld.PawnShop
{
    public partial class Comments : System.Web.UI.Page
    {
        ...
        {
            int RecordCount = 0;
            GridView1.DataSource = bll.GetList(PageIndex, AspNetPager.PageSize,"p.pawnproductname", AppType.News, "inner join mwpawnproduct p on c.targetid=p.pawnproductid", out RecordCount);
            GridView1.DataBind();
