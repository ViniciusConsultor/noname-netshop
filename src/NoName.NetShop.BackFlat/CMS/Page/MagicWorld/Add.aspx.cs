...
namespace NoName.NetShop.BackFlat.CMS.Page.MagicWorld
{
    ...
    {
        private PageCategoryElement Element = ((PageCategorySection)ConfigurationManager.GetSection("pageCategorySection")).PageCategories["MagicWorld"];
        ...
        {
            DropDownList_Template.DataSource = TemplateControler.GetTemplateList(PageCategory.MagicWorld);
