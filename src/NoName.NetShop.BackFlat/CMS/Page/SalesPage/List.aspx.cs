...
namespace NoName.NetShop.BackFlat.CMS.Page.SalesPage
{
    public partial class List : System.Web.UI.Page
    {
        ...
        {
            int RecordCount = 0;
            DataTable dt = PageControler.GetList(PageIndex, AspNetPager.PageSize, PageCategory.SalesPage, out RecordCount);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.RowState == DataControlRowState.Normal || e.Row.RowState == DataControlRowState.Alternate)
                {
                    ...
                    string ScriptString = String.Format("javascript:return confirm('是否确认删除专题\"{0}\"？')", e.Row.Cells[1].Text);
