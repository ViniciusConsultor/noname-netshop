    ...
    <form id="form1" runat="server" enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    北京：
                    <asp:CheckBoxList ID="CheckBoxList_BJ" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Text="有货" Value="1" Selected="True" />
                        <asp:ListItem Text="无货" Value="0" />
                    </asp:CheckBoxList>
                    广州：
                    <asp:CheckBoxList ID="CheckBoxList_GZ" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Text="有货" Value="1" Selected="True" />
                        <asp:ListItem Text="无货" Value="0" />
                    </asp:CheckBoxList>
                    呼和浩特：
                    <asp:CheckBoxList ID="CheckBoxList_HH" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Text="有货" Value="1" Selected="True" />
                        <asp:ListItem Text="无货" Value="0" />
                    </asp:CheckBoxList>
                    上海：
                    <asp:CheckBoxList ID="CheckBoxList_SH" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Text="有货" Value="1" Selected="True" />
                        <asp:ListItem Text="无货" Value="0" />
                    </asp:CheckBoxList>
                </td>
