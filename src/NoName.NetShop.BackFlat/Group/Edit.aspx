<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" ValidateRequest="false" Inherits="NoName.NetShop.BackFlat.Group.Edit" %>
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span type="inform" class="red"></span>
                    <asp:Image runat="server" ID="Image_ProductImage" />
                </td>
            </tr>
            <tr>
                <td></td>
