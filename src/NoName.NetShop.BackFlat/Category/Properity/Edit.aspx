<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="NoName.NetShop.BackFlat.Category.Properity.Edit" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button runat="server" ID="Button_Edit" OnClick="Button_Eidt_Click" Text="提交" />
