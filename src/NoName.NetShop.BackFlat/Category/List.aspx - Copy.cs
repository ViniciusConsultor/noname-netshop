...
namespace NoName.NetShop.BackFlat.Category
{
    public partial class List : System.Web.UI.Page
    {
        ...
        protected void Button1MoveUp_Click(object sender, EventArgs e)
        {
            ...
            BindList1Data();
            ListBox1.SelectedValue = OriginCateID.ToString();
        }
        ...
        protected void Button2MoveUp_Click(object sender, EventArgs e)
        {
            ...
            bll.SwitchOrder(OriginCateID, SwitchCateID);
            BindList2Data(Convert.ToInt32(ListBox1.SelectedValue));
            ListBox2.SelectedValue = OriginCateID.ToString();
        }
        ...
        protected void Button3MoveUp_Click(object sender, EventArgs e)
        {
            ...
            bll.SwitchOrder(OriginCateID, SwitchCateID);
            BindList3Data(Convert.ToInt32(ListBox2.SelectedValue));
            ListBox3.SelectedValue = OriginCateID.ToString();
        }
        ...
        {
            Response.Redirect("edit.aspx?categoryid=" + ListBox1.SelectedItem.Value);
        }
        protected void Button2Edit_Click(object sender, EventArgs e)
        {
            Response.Redirect("edit.aspx?categoryid=" + ListBox2.SelectedItem.Value);
        }
        protected void Button3Edit_Click(object sender, EventArgs e)
        {
            Response.Redirect("edit.aspx?categoryid=" + ListBox3.SelectedItem.Value);
        }
