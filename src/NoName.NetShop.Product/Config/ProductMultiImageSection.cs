...
{
    public class ProductMultiImageSection : ConfigurationSection
    {
        ...
        private static readonly ConfigurationProperty _ImageTypes = new ConfigurationProperty(null, typeof(ProductMultiImageElementCollection), null, ConfigurationPropertyOptions.IsDefaultCollection);


        private static ConfigurationPropertyCollection _Properties = new ConfigurationPropertyCollection();

        public ProductMultiImageSection()
        {
        ...
        public ProductMultiImageElementCollection ImageTypes
        {
            get { return(ProductMultiImageElementCollection)base[_ImageTypes];}
        }
