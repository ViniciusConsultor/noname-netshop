...
namespace NoName.NetShop.UserManager.DAL
{
	...
	public class MemberSchool
	{
		...
		public NoName.NetShop.UserManager.Model.MemberSchool GetModel(int userid)
		{
			...
			NoName.NetShop.UserManager.Model.MemberSchool model=null;
		...
		/// </summary>
		public List<NoName.NetShop.UserManager.Model.MemberSchool> GetListArray(string strWhere)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select userid,truename,duty,school,province,city,county,Mobile,TelePhone,Fax,Email ");
			strSql.Append(" FROM umMemberSchool ");
			...
			List<NoName.NetShop.UserManager.Model.MemberSchool> list = new List<NoName.NetShop.UserManager.Model.MemberSchool>();
			Database db = NoName.NetShop.Common.CommDataAccess.DbReader;
		...
		/// 对象实体绑定数据
		/// </summary>
		public NoName.NetShop.UserManager.Model.MemberSchool ReaderBind(IDataReader dataReader)
		{
