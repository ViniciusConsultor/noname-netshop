<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" ValidateRequest="false" MasterPageFile="~/Site.master" Inherits="NoName.NetShop.ForeFlat.member.Secondhand.Add" %>
...
<asp:Content runat="server" ID="Content1" ContentPlaceHolderID="cpMain">    
    ...
    <div class="currentPosition">
    	您现在的位置: <a href="/">首页</a> &gt;&gt; <a href="/member/myorders.aspx">我的鼎鼎</a> &gt;&gt; <a href="/member/Secondhand/List.aspx">我的二手</a> &gt;&gt; <a href="#">添加商品</a>
    </div>
    <!--Position End-->
