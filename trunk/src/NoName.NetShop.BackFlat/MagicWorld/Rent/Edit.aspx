<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="NoName.NetShop.BackFlat.MagicWorld.Rent.Edit" %>
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <a href="../Category/Select.aspx?app=Rent&pid=<%= RentID  %>" >重新选择</a>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:FileUpload runat="server" ID="FileUpload_MainImage" />
                    <asp:Image runat="server" ID="Image_MainImage" />
                    <span type="inform" class="red"></span>
                </td>
            </tr>
        </table>
        <asp:Button runat="server" ID="Button_Edit" Text="提交" OnClick="Button_Edit_Click" />
    </div>
    </form>
</body>
</html>
