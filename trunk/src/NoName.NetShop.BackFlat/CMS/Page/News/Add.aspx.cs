...
namespace NoName.NetShop.BackFlat.CMS.Page.News
{
    ...
    {
        private PageCategoryElement Element = ((PageCategorySection)ConfigurationManager.GetSection("pageCategorySection")).PageCategories["News"];
        ...
        protected void Button_Add_Click(object sender, EventArgs e)
        {
            ...
            page.Category = (int)PageCategory.News;
