...
namespace NoName.NetShop.BackFlat
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        private static string DivMenuFormat = "<a class=\"groupName\" href=\"{0}\" onclick=\"clickGroup(this)\" title=\"{1}\">{2}</a>";
        private static string LiMenuFormat = "<li><a href=\"{0}\" target=\"mainPage\" title=\"{1}\">{2}</a></li>";
        ...
        private void BuilderSonMenus(SiteMapNode snode)
        {
            ...
            {
                menu.Append("<ul class=\"options\" style=\"display:none\">");
        ...
        {
            return String.Format(format, String.IsNullOrEmpty(node.Url) ? "javascript:void(0)" :
