...
namespace NoName.NetShop.DAL
{
	...
	public class ProductParaModelDal
	{
		...
		/// </summary>
		public List<NoName.NetShop.Model.ProductParaModel> GetListArray(string strWhere)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ProductId,ParaId,ParaValue ");
			strSql.Append(" FROM pdProductPara ");
			...
			List<NoName.NetShop.Model.ProductParaModel> list = new List<NoName.NetShop.Model.ProductParaModel>();
			Database db = DatabaseFactory.CreateDatabase();
