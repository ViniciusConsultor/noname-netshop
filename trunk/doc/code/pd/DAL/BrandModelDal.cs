...
namespace NoName.NetShop.DAL
{
	...
	public class BrandModelDal
	{
		...
		/// </summary>
		public List<NoName.NetShop.Model.BrandModel> GetListArray(string strWhere)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select BrandId,BrandName,CateId,CatePath,BrandLogo,Brief ");
			strSql.Append(" FROM pdBrand ");
			...
			List<NoName.NetShop.Model.BrandModel> list = new List<NoName.NetShop.Model.BrandModel>();
			Database db = DatabaseFactory.CreateDatabase();
